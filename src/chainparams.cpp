...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("00000eeb9b527583d8586c6c88b1cdfaa5032cac7c0c7ed0dcc3e4dda858b7ae"))
                              ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1548393960, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "Snow brings parts of Europe to standstill";
        ...
        genesis.nTime = 1548393960;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3975176;
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("00000eeb9b527583d8586c6c88b1cdfaa5032cac7c0c7ed0dcc3e4dda858b7ae"));
        assert(genesis.hashMerkleRoot == uint256("7716747c16839f5a172a294ec4d606bb32d0fd5b7e17eb6ac5916b661481813b"));
        ...
        nStartMasternodePayments = 1548393960; //Wed, 25 Jun 2014 20:36:16 GMT
...
public:
    CTestNetParams()
    {
        ...
        nStartMasternodePayments = 1548393960; //Fri, 09 Jan 2015 21:05:58 GMT
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
